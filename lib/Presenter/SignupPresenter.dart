  ...
  Future<UserModel> getRegister(BuildContext context,String name,String email,String pass,String mobileNum) async {
    ...
    try {
      Response<String> response = await _dio.post(
          AppConstant.BaseUrl + AppConstant.API_SIGNUP, data: formData);
      ...
      if (response.statusCode == 200) {
        ...
        print("register response------------------------errr" +response.data.toString());
        Fluttertoast.showToast(
      ...
      Fluttertoast.showToast(
          msg: 'Error in server or API controller!',
          toastLength: Toast
              .LENGTH_SHORT,
          timeInSecForIosWeb: 1,
          backgroundColor: Colors.grey,
