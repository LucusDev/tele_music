...
class ModelMusicLanguage {
  ...
  List<Data> data;
  ModelMusicLanguage(
      this.status, this.msg, this.imagePath, this.selectedLanguage, this.data);
  ...
  factory ModelMusicLanguage.fromJson(Map<dynamic, dynamic> json) {
    ...
    return ModelMusicLanguage(json['status'], json['msg'], json['imagePath'], l,
...
class Data {
  ...
  Data(this.id, this.language_name, this.language_code, this.image, this.status,
