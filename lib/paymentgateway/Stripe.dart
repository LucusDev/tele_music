...
class StripePay extends StatefulWidget {
  StripePay(String planName, String amountToBePaid, String planid, String id,
...
class _HomeScreenState extends State<StripePay> {
  ...
  getValue() async {
    ...
    Stripe.merchantIdentifier = modelSettings
        .payment_gateways.stripe.stripe_merchant_country_identifier;
  ...
  Future<void> apicall(String pay_data) async {
    String res = await PlanPresenter()
        .singleSongPay("stripe", "" + plan_id, "" + pay_data, token);
        ...
        child: (hasData && payLoading)
            ...
            : Container(
                child: CircularProgressIndicator(
                    valueColor:
                        AlwaysStoppedAnimation(appColors().primaryColorApp),
  ...
  Future<void> makePayment() async {
    try {
      paymentIntentData = await createPaymentIntent(
          '' + amountPlan.round().toString(),
          "" + CurrencyCode); //json.decode(response.body);
      ...
      await Stripe.instance
          .initPaymentSheet(
              paymentSheetParameters: SetupPaymentSheetParameters(
                  ...
                  merchantDisplayName: modelSettings
                      .payment_gateways.stripe.stripe_merchant_display_name))
          .then((value) {});
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Cancel Payment! Error")));
...
//orderPlace();
        ...
        ScaffoldMessenger.of(context)
            .showSnackBar(SnackBar(content: Text("Cancel Payment!")));
        Navigator.pop(context);
      });
