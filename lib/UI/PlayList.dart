                      ...
                      if (projectSnap.hasData) {
                          ...
                          return Container(
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    height: 250,
                                    margin: EdgeInsets.fromLTRB(18, 100, 18, 2),
                                    child: Image.asset(
                        ...
                        return Container(
                            ...
                            margin: (Platform.isAndroid)
                                ? (allowAds)
                                    ? EdgeInsets.fromLTRB(12, 200, 3, 29)
                                    : EdgeInsets.fromLTRB(6, 80, 3, 70)
                                : EdgeInsets.fromLTRB(6, 80, 3, 70),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            ...
                                                                            border: Border.all(width: 0.1, color: appColors().colorHint)),
                                                                        margin: EdgeInsets.fromLTRB(0, 3, 5, 16.5),
                                                                        child: Icon(
                                                                          Icons
                                                                              .cancel,
                                                                          color:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            ...
                                                                            border: Border.all(width: 1.5, color: appColors().colorText)),
                                                                        child: Image
                                                                            .asset(
                ...
                child: InkResponse(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(30.0)),
                    margin: (Platform.isAndroid)
                        ? EdgeInsets.fromLTRB(11, 68, 25, 88)
                        : EdgeInsets.fromLTRB(11, 68, 28, 115),
                    child: Text(
                      '+',
                      textAlign: TextAlign.center,
                      style: TextStyle(
