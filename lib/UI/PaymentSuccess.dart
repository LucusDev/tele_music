...
class PaymentSuccess extends StatefulWidget {
  PaymentSuccess(String paymentType, String planId, String paymentId,
      String orderId, String amountToPaid, String jsonData) {
    plan_id = planId;
...
class MyState extends State {
  ...
  Future<void> api() async {
    await PlanPresenter()
        .savePlan(payment_type, plan_id, jsonpayData, order_id, token);
  }
