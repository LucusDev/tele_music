            ...
            StreamBuilder<MediaState>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    ...
                    if (duration.inMilliseconds.toDouble() >=
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: (mediaState.mediaItem!.artUri
                                              .toString()
                                              .isEmpty ||
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    '' + mediaState.mediaItem!.title.toString(),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    '' +
                                        mediaState.mediaItem!.artist.toString(),
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        fontSize: 14,
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                borderRadius:
                                    BorderRadiusDirectional.circular(4.0),
                                image: DecorationImage(
                                  image: (musicImage.contains("file://"))
                                      ? AssetImage(
                                          'assets/images/placeholder2.jpg')
                                      : (!musicImage.isEmpty)
