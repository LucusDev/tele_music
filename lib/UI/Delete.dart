          ...
          child: Stack(alignment: Alignment.topCenter, children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Text(
                    "Do you want to parmantly delete your account ? after deleting your account and all related information will no longer exist and you have to register again.\n"
            ...
            Align(
              ...
              child: InkResponse(
                ...
                onTap: () async {
                  int res =
                      await Logout().deleteApi(context, token, model.data.id);
                  if (res == 1) {
