  ...
  Future<void> fetchData() async {
    ...
    try {
      final response = await CatSubcatMusicPresenter()
          .getMusicCategory(token, typ, _pageNumber, _numberOfPostsPerRequest);
        ...
        children: [
          ...
          TextButton(
              ...
              child: Text(
                "Retry",
                style: TextStyle(
                    fontSize: 20, color: appColors().PrimaryDarkColorApp),
              )),
        ],
      ),
    );
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      InkResponse(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: post.image.isEmpty
                                  ...
                                  : NetworkImage(
                                      AppConstant.ImageUrl + path + post.image,
                                    ) as ImageProvider,
                              fit: BoxFit.cover,
                        ...
                        onTap: () {
                          if (typ.contains("Albums") ||
                              typ.contains("Artists") ||
                              typ.contains("Genres")) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => MusicList(_audioHandler,
                                      "" + post.id.toString(), typ, post.name)),
                            ).then((value) {
                              debugPrint(value);
                              _reload();
                            });
