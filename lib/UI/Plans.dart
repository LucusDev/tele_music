...
//               ),
//               if (!loadingPlan)
//                 if ((noData || (modelSettings.data.plan_expiry_date.isEmpty)))
//                   Align(
//                       alignment: Alignment.topLeft,
...
//                           : Container()),
//               if (!loadingPlan)
//                 if ((!(modelSettings.data.plan_expiry_date.isEmpty)))
//                   Container(
//                       height: 201,
...
//                             child: Text(
//                               '$currencySym' +
//                                   modelSettings.data.plan_detail.plan_amount,
...
//                                 if (!loadingPlan)
//                                   if (modelSettings
//                                       .data.plan_detail.plan_name.isNotEmpty)
//                                     Container(
//                                       alignment: Alignment.centerLeft,
...
//                                     alignment: Alignment.centerLeft,
//                                     child: Text(
//                                       (modelSettings.data.plan_detail.validity >
//                                                   1 &&
//                                               currentPlanData.is_month_days ==
//                                                   0)
//                                           ? 'Validity ' +
//                                               modelSettings
//                                                   .data.plan_detail.validity
//                                                   .toString() +
//                                               " " +
//                                               dayMon
//                                           : 'Validity ' +
...
//                                 if (!loadingPlan)
//                                   if (modelSettings
//                                       .data.purchased_plan_date.isNotEmpty)
//                                     Container(
//                                       margin: EdgeInsets.fromLTRB(0, 0, 0, 0),
//                                       alignment: Alignment.centerLeft,
//                                       child: Text(
//                                         (modelSettings.data.purchased_plan_date
//                                                 .isEmpty)
//                                             ? " Expired"
//                                             : "Purchased On " +
//                                                 modelSettings
//                                                     .data.purchased_plan_date,
//                                         textAlign: TextAlign.left,
//                                         style: TextStyle(
//                                             fontFamily: 'Nunito-Bold',
//                                             fontSize: 15,
...
//                 Container(
//                   padding:
//                       (noData || (modelSettings.data.plan_expiry_date.isEmpty))
...
//                   ? Container(
//                       margin: (noData ||
//                               (modelSettings.data.plan_expiry_date.isEmpty))
...
//                             return (int.parse(listPlans[index].plan_amount) <=
//                                     0)
//                                 ? Container()
//                                 : Container(
...
//                                                                       .isNotEmpty) {
//                                                                     if (int.parse(
//                                                                             listPlans[int.parse(planindex)].plan_amount) >
//                                                                         0) {
//                                                                       Navigator
//                                                                           .push(
//                                                                         context,
...
//                                                                               checkBox,
//                                                                               listPlans[int.parse(planindex)].plan_amount,
//                                                                               '' + listPlans[int.parse(planindex)].id.toString()),
//                                                                         ),
//                                                                       );
//                                                                     } else {
//                                                                       Fluttertoast.showToast(
//                                                                           msg:
//                                                                               'Amount not valid for payment',
//                                                                           toastLength: Toast
//                                                                               .LENGTH_SHORT,
//                                                                           timeInSecForIosWeb:
//                                                                               1,
...
//                                                                           gradient:
//                                                                               LinearGradient(
//                                                                             colors: (planIdCheck.contains(listPlans[index].id.toString()))
//                                                                                 ? [
//                                                                                     appColors().white,
//                                                                                     appColors().white,
//                                                                                   ]
...
//                                                                   child: Text(
//                                                                     (planIdCheck.contains(listPlans[index]
//                                                                             .id
//                                                                             .toString()))
//                                                                         ? 'Buy'
//                                                                         : '',
...
//                                                                         fontSize:
//                                                                             16.5,
//                                                                         color: (planIdCheck.contains(listPlans[index].id.toString()))
//                                                                             ? appColors().primaryColorApp
//                                                                             : appColors().white),
//                                                                   )),
//                                                             ),
...
//                                                                     fontSize:
//                                                                         16,
//                                                                     color: checkBox.contains(listPlans[index]
//                                                                             .plan_name)
//                                                                         ? appColors()
//                                                                             .white
//                                                                         : appColors()
