...
class StateClass extends State {
  ...
  final Color color = Color(0xfffee400);
            ...
            child: Stack(
              children: <Widget>[
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      height: 340,
                                      margin:
                                          EdgeInsets.fromLTRB(32, 90, 32, 5),
                                      child: Image.asset(
                ...
                Container(
                  ...
                  margin: (allowAds)
                      ? EdgeInsets.fromLTRB(0, 126, 0, 32)
                      : EdgeInsets.fromLTRB(0, 75, 0, 32),
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              contentPadding: IphoneHasNotch.hasNotch
                                  ? EdgeInsets.fromLTRB(15, 6, 15, 8)
                    ...
                    if (is_yt == 1)
                      SliverToBoxAdapter(
                        ...
                        child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemBuilder: (context, index) {
                            String imagepath = videoResult[index]
                                .thumbnail
                                .medium
                                .url
                                .toString();
