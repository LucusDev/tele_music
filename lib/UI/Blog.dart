                  ...
                  builder: (context, AsyncSnapshot projectSnap) {
                    if (projectSnap.hasData) {
                      final Map<dynamic, dynamic> parsed =
                          json.decode(projectSnap.data.toString());
                                ...
                                Stack(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      backgroundImage: _blogModel
                                              .data.blogs[index].image.isEmpty
                                          ? AssetImage('assets/icons/user2.png')
                                          : NetworkImage(AppConstant.ImageUrl +
                                              "images/blogs/" +
                                              _blogModel.data.blogs[index]
                                                  .image) as ImageProvider,
                                    ),
                                    Container(
                                      margin: EdgeInsets.fromLTRB(65, 4, 0, 2),
                                      child: Text(
                                          _blogModel
                                              .data.blogs[index].blog_cat_name,
                                          style: TextStyle(
                                              fontSize: 20,
                                    ...
                                    Container(
                                      margin: EdgeInsets.fromLTRB(65, 29, 0, 2),
                                      child: Text(
                                          _blogModel
                                              .data.blogs[index].created_at
                                              .split("T")
                                              .first,
                                          style: TextStyle(
                                              fontSize: 12,
